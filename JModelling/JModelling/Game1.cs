...
namespace JModelling
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            Console.WriteLine(meshWater.GetPosition());
            meshWater.MoveTo(pos.X, 10, pos.Z);
            cube.MoveTo(pos.X, 0/*generator.GetHeightAt(pos.X, pos.Z)*/, pos.Z);
